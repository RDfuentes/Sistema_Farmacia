<div class="row">
	<div class="col-md-12">
	<h1>Venta</h1>
	<p><b>Buscar producto por codigo o producto:</b></p>
		<form id="searchp">
		<div class="row">
			<div class="col-md-6">
...
$total = 0;
?>
<h2 class="text-center">Lista de venta</h2>
<table class="table table-bordered table-hover">
<thead>
...
<tr >
	...
	<td><?php echo $product->barcode; ?></td>
	<td ><?php echo $p["q"]; ?></td>
	<td><b>Q. <?php echo ($product->price_out); ?></b></td>
	<td><b>Q. <?php  $pt = $product->price_out*$p["q"]; $total +=$pt; echo ($pt); ?></b></td>
...
<h2>Resumen</h2>
    ...
    <label for="inputEmail1" class="col-lg-2 control-label">Cliente</label>
	  ...
	  <div class="form-group">
	  	<div>
	 		<label for="inputEmail1" class="col-lg-5 control-label" style="color:red">Descuento 1 = <b>Q. <?php echo ($product->unit); ?></b></label>
	  	</div>
	  	<div>
	 		<label for="inputEmail1" class="col-lg-5 control-label" style="color:red">Descuento 2 = <b>Q. <?php echo ($product->descuento); ?></b></label>
	  	</div>
	  </div>
...
<script>
	$("#processsell").submit(function(e){
		...
		if(money<(<?php echo $total;?>-discount)){
			...
			go = confirm("Cambio: Q."+(money-(<?php echo $total;?>-discount ) ) );
			if(go){}
