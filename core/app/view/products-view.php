...
<div class="btn-group  pull-right">
	<a href="index.php?view=newproduct" class="btn btn-danger"> <i class='fa fa-plus'> Añadir Productos</i></a>
<div class="btn-group pull-right">
	...
	<tr>
		...
		<td>
			<?php if($product->image!=""):?>
				<img src="storage/products/<?php echo $product->image;?>" style="width:50px; height:30px;">
			<?php endif;?>
		</td>
...
<div class="clearfix"></div>
	...
	<div class="jumbotron">
		...
		<p>No se han agregado productos a la base de datos, puedes agregar uno dando click en el boton <b>"Añadir Productos"</b>.</p>
	</div>
	<?php
}
