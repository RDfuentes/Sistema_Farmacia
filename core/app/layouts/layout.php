    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>FARMACIA SHALOM</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="./?view=categories">Ingreso de categorias</a></li>
                <li><a href="./?view=products">Ingreso de productos</a></li>
                <li><a href="./?view=inventary">Inventario de productos</a></li>
                <li><a href="./?view=re">Abastecer productos</a></li>
                <li><a href="./?view=res">Historial de reabastecimientos</a></li>
              </ul>
            </li>

            <li class="treeview">
              <a href="#"><i class='fa fa-cube'></i> <span>Caja</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="./?view=sell"><i></i> <span>Vender productos</span></a></li>
                <li><a href="./?view=sells"><i></i> <span>Lista de ventas</span></a></li>
                <li><a href="./?view=box"><i></i> <span>Apertura y cierre de caja</span></a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="./?view=clients"><i></i> <span>Clientes</span></a></li>
                <li><a href="./?view=providers"><i></i> <span>Proveedores</span></a></li>
              </ul>
            </li>    
            ...
            <li class="treeview">
              <a href="./?view=users"><i class='fa fa-cog'></i> <span>Usuarios</span></a>
            </li>
            
            <li class="treeview">
              <a href="./?view=notas"><i class='fa fa-book'></i> <span>Notas</span></a>
            </li>
...
<div class="login-box">
      <div class="login-logo">
        <a href="./"><b>NOMBRE DEL NEGOCIO</b></a>
      </div><!-- /.login-logo -->
